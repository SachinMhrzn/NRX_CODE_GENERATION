...
@Singleton
public class InhibitorMetacodeService extends AbstractMetacodeGenerator {
    ...
    /**
     * Validates if the metacodeDto is qualifies for Inhibitor metacode service.
     *
    ...
    public Boolean isQualified(MetacodeDto metacodeDto) {
        return MetacodeBaseUtil.isInhibitorMetacodeDto(metacodeDto);
    }
    ...
    public Integer getPriority() {
        return NrxCodeConstant.INHIBITOR_METACODE_PRIORITY;
    }
}
