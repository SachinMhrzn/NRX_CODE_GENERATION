...
@Singleton
public class CtmMetacodeService extends AbstractMetacodeGenerator {
    ...
    /**
     * Validates if the metacodeDto is qualifies for CTM metacode service.
     *
    ...
    public Boolean isQualified(MetacodeDto metacodeDto) {
        return MetacodeBaseUtil.isCtmMetacodeDto(metacodeDto);
    }
    ...
    public Integer getPriority() {
        return NrxCodeConstant.CTM_METACODE_PRIORITY;
    }
}
